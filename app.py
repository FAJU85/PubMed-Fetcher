...
EMAIL = "qq.q2@outlook.sa"  # ← YOUR EMAIL
SHEET_ID = "1rizbL69aBz1gC746U2iJy5k3lIYlk9vRRZCogk174sg"  # ← YOUR SHEET ID
AUTHOR_NAME = "Alfadda AA"

# Google Sheets credentials (download from Google Cloud Console)
# Download service account JSON from: https://console.cloud.google.com/apis/credentials
# Place it as 'service-account.json' in this folder
GOOGLE_CREDS_FILE = "service-account.json"

# Journal metadata (same as your HTML)
JOURNAL_METADATA = {
